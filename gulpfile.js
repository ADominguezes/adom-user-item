...
/* ======================================================================================================
* Task for insert estiles en el adom-user-item-styles.html
* ======================================================================================================*/
gulp.task('styles-replace', ['styles'], function () {
    return gulp.src('./adom-user-item-styles.html')
        .pipe(replace(/<style>[^>]*<\/style>/, function (s) {
            var style = fs.readFileSync('./dist/css/adom-user-item.css', 'utf8');
            return '<style>\n' + style + '\n</style>';
        }))
        .pipe(gulp.dest('./'))
        .pipe(browserSync.stream());
...
gulp.task('serve', ['styles-replace', 'styles', 'watch'], function () {
    browserSync.init({
        injectChanges: true,
        files: ['./*.{html, scss}', './demo/index.html', './adom-user-item.js', './dist/css/adom-user-item.css'],
        server: "./",
    });
});

/* ======================================================================================================
* watch changes in files adom-user-item.scss and adom-user-item.html
* ======================================================================================================*/
gulp.task('watch', function () {
    gulp.watch('./adom-user-item.html', ['styles-replace']); // Vigila cambios en el html
    gulp.watch('./dist/css/adom-user-item.css', ['styles-replace']); // Vigila cambios en el html
